...
async function setupViewer(){
    ...
    function setupScrollanimation(){
        ...
        tl
        .to(position, {x: isMobile ? -6.0 : 7.2551642915, y: isMobile ?  5.5 :  5.7931680919, z: isMobile ? -3.3 :  -3.1112188667,
            scrollTrigger: {
                trigger: ".second",
                start:"top bottom",
        ...
        .to(target, {x: isMobile ? -1.1 : 0.6993413138, y: isMobile ? 1.0 : 1.0423850616 , z: isMobile ? -0.1 : 2.3243015461,
            scrollTrigger: {
                trigger: ".second",
                start:"top bottom",
                end: "top top", scrub: true,
